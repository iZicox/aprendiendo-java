...
public class Rectangulo {
	...
	public Rectangulo (Punto punto1, Punto punto2) {
		this.x1=punto1.obtenerX();
		this.y1=punto1.obtenerY();
		this.x2=punto2.obtenerX();
		this.y2=punto2.obtenerY();
	}
	public Rectangulo (int ancho,int alto, Punto punto1) {
		this.x1=punto1.obtenerX();
		this.y1=punto1.obtenerY();
		this.x2=ancho+punto1.obtenerX();
		this.y2=alto+punto1.obtenerY();
	}
